...
contract BtcToker {
    ...
    //返回指定地址的代币余额
    function balanceOf(address account) public view r
    ...
    //从一个地址向另一个地址转移代币（需要实现授权）
    function transferFrom(address from,address to,uint256 amount) public {
        uint256 _allowance=_allowances[msg.sender][from];
